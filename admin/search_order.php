...
<form name="form1" method="post" action="db_search_order.php" enctype="multipart/form-data">
    <table width="80%" border="0" align="center">
      <tr>
        <td width="16%">Order ID</td>  
        <td width="84%"><input type="text" name="search_order" size="50" />
      </tr>  
       <tr> 
